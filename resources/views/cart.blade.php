      ...
      <div id="cartContent" class="p-4" style="min-height: 300px; overflow-y: auto;">
        ...
        <div class="flex gap-6 pb-6 border-b mb-6">
          ...
          <div class="flex-1">
            ...
            <p class="text-gray-500">₱9,780.00</p>
            <div class="flex items-center gap-4">
              <form method="POST" action="{{ route('cart.update') }}" class="flex items-center border rounded">
                @csrf
                <button type="submit" name="decrement" class="px-3 py-1 hover:bg-gray-100 rounded-l">-</button>
                <input type="text" name="quantity" value="<?php echo htmlspecialchars($quantity); ?>" class="w-12 text-center border-x" readonly>
                <button type="submit" name="increment" class="px-3 py-1 hover:bg-gray-100 rounded-r">+</button>
              </form>
